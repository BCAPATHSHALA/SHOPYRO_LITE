...
import { ArrowRight, PlusCircleIcon, ShoppingCart } from "lucide-react";
  ...
  return (
    <>
      <Button
        ...
        variant="ghost"
      >
        {/* Optional text on larger screens */}
        <span className="max-md:hidden uppercase">Cart</span>
        ...
        {cart?.totalQuantity && cart.totalQuantity > 0 && (
          <span className="absolute -top-1 -right-1 inline-flex items-center justify-center rounded-full bg-red-500 text-white text-xs w-5 h-5 font-bold">
            {cart.totalQuantity}
          </span>
        )}
      </Button>
